...
public class ItemController {
    ...
    @GetMapping("/refresh")
    public CommonJsonResult refresh(@RequestParam String itemSpecIds) {
        String[] specIds = itemSpecIds.split(",");
        List<String> list = new ArrayList<>(Arrays.asList(specIds));
        return CommonJsonResult.ok(itemService.queryItemBySpecIds(list));
    }
}
